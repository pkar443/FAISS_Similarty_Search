"""FAISS similarity search demo with cosine, flat L2, and IVF comparisons."""
...
# This script shares its name with the FAISS package, so remove the script
# directory from sys.path before importing the installed dependency.
